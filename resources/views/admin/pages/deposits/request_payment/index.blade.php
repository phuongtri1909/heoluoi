            ...
            <div class="card mb-4 mx-0 mx-md-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div>
                            <button class="btn bg-gradient-danger btn-sm" id="deleteExpiredBtn" data-url="{{ route('admin.request.payments.delete-expired') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($payment->is_completed)
                                                ...
                                                @if($payment->deposit)
                                                    <a href="{{ route('admin.deposits.index', ['search' => $payment->deposit->transaction_code]) }}" class="badge badge-sm bg-gradient-info text-white">
                                                        Xem giao dịch
                                                    </a>
                                                @endif
